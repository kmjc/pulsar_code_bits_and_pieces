#!/usr/bin/env python
# minor tweaks from https://github.com/scottransom/presto/blob/master/python/presto/sigproc.py
# - took out the presto import of ARCSECTORAD
# - changed the write out etc
