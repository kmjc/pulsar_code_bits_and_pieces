...
from chunk_clip_mask_dedisp import (
...
if __name__ == "__main__":
    ...
    if not_zero_or_none(args.outfilename):
        ...
        outfilename = args.filename[:-3] + "h5"
    ...
    print(h.heap())
    verbose_message2(f"Size of fmdt array: {sys.getsizeof(out.base)/1000/1000} MB")
    verbose_message2(f"Size of fdmt A: {sys.getsizeof(fd.A)/1000/1000} MB")
